    ...
    <div className="container mx-auto py-16 px-4 md:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose max-w-none">
          <p className="lead">
            At Silsilat, we are committed to protecting your privacy and personal information. This Privacy Policy
          ...
          <ul className="list-disc pl-6 my-4">
            ...
            <li>Business information for Ar-Rahnu Operators</li>
            <li>Financial information for funding and transaction purposes</li>
            <li>Identity verification information, such as identification documents</li>
          ...
          <ul className="list-disc pl-6 my-4">
            ...
            <li>Connecting Ar-Rahnu Operators with funders</li>
            <li>Verifying identity and preventing fraud</li>
            <li>Communicating with you about our Services</li>
            <li>Sending promotional messages and marketing communications</li>
          ...
          <ul className="list-disc pl-6 my-4">
            <li>Other users of our platform as necessary to facilitate transactions (e.g., AROs and funders)</li>
            <li>Service providers who perform services on our behalf</li>
            <li>Financial institutions and payment processors to facilitate transactions</li>
            <li>Professional advisors, such as lawyers, auditors, and insurers</li>
            <li>Government authorities, law enforcement, and others as required by law</li>
            <li>Business partners and affiliates with your consent</li>
          </ul>
          ...
          <p>
            ...
            to remember your preferences. You can manage your cookie preferences through your browser settings. However,
            refusing cookies may affect certain features of our Services.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">7. Third-Party Links and Services</h2>
          <p>
            Our Services may contain links to third-party websites or services that are not owned or controlled by
            Silsilat. We have no control over and assume no responsibility for the content, privacy policies, or
            practices of any third-party websites or services. We encourage you to review the privacy policies of any
          ...
          <p>
            ...
            Privacy Policy, unless a longer retention period is required or permitted by law. When we no longer need to
            use your information, we will either securely delete or anonymize it.
          </p>
          ...
          <p>
            ...
            reside. These countries may have data protection laws that differ from the laws of your country. When we
            transfer your information, we take appropriate safeguards to ensure that your information receives an
          ...
          <p>
            ...
            to review this Privacy Policy periodically to stay informed of how we use and protect your information.
          </p>
